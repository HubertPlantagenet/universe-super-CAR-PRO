#include<Arduino.h>
#include<Laserdistance.h>
#include<Wire.h>
//this is a programm about the laser ranging,this range is 0.02m~2m!!!  --Finish by LH laboratory
...
int makeuint16(int lsb, int msb) {
...
int VL53L0X_decode_vcsel_period(short vcsel_period_reg) {
